...
public class SmsSender implements SmsEventListener
{
    ...
    public SmsSender(String tekst,String numer)
    {
        ...
        String smsUsername = "piotrek.sloma94@gmail.com";
        String smsPassword = "wlatx";
        ...
        sms.setMessage( tekst );
        sms.setRecipient( "48"+numer ); // The recipients phone number.
